...
class StringDeque {
 public:
  explicit StringDeque(int n) : data_(n, ""), size_(0), head_(0), tail_(0) {
  }


  bool operator== (const StringDeque &b)
  {
...
class StringStack {
    friend bool operator==(const StringStack &a, const StringStack &b);
 public:
